    ...
    return (
        <Card className="custom-card-lab">
            <div className="custom-card-lab-header">
                ...
                <Typography variant="h4" component="div" className="custom-card-lab-title">
                    {title}
                </Typography>
            </div>
            <div className="upper-section-lab">
                <a href={desc} target="_blank" rel="noopener noreferrer" className="custom-button-lab">
                    Εκφώνηση εργαστηρίου
                </a>
            </div>
            <div className="lower-section-lab">
                <a href={solution} target="_blank" rel="noopener noreferrer" className="custom-button-lab">
                    Λύση εργαστηρίου
                </a>
            </div>
        </Card>
